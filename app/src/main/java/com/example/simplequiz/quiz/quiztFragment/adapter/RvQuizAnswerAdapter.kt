...
class RvQuizAnswerAdapter(context : Context, private val answerList : ArrayList<String>, private val view : QuizFragmentView) : RecyclerView.Adapter<RvQuizAnswerAdapter.ViewHolder>(){
